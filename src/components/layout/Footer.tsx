        ...
        <footer className="bg-secondary border-t border-white/5">
            <div className="max-w-6xl mx-auto px-4 py-6 md:py-8">
                <div className="flex flex-col gap-6 md:flex-row md:justify-between md:items-center md:gap-4">
                    ...
                    <div className="flex items-center justify-center md:justify-start gap-2 text-color-text-secondary text-sm order-2 md:order-1">
                        <span>{t("footer.madeWith")}</span>
                        <span className="text-red-400 animate-pulse">❤️</span>
                        <span>{t("footer.by")} Maximilien</span>
                    </div>

                    {/* Center - Technologies */}
                    <div className="flex items-center justify-center gap-2 md:gap-3 text-color-text-secondary text-xs md:text-sm order-1 md:order-2">
                        <div className="flex items-center gap-1">
                            <svg className="w-5 h-5 md:w-6 md:h-6 text-[#61DAFB]" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <span className="text-color-text-tertiary hidden sm:inline">•</span>
                        <div className="flex items-center gap-1">
                            <svg className="w-5 h-5 md:w-6 md:h-6 text-[#3178C6]" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <span className="text-color-text-tertiary hidden sm:inline">•</span>
                        <div className="flex items-center gap-1">
                            <svg className="w-5 h-5 md:w-6 md:h-6 text-[#06B6D4]" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div className="flex flex-col items-center gap-3 text-xs md:text-sm order-3 md:order-3">
                        ...
                        >
                            ...
                            <span>{t("footer.viewCode")}</span>
                        </a>
                        <div className="text-color-text-secondary text-center">
