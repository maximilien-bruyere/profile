                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-4 text-sm">
                        <a 
                            ...
                            className="flex items-center gap-2 text-color-text-secondary hover:text-accent transition-colors duration-300"
                        >
                        ...
                        <span className="text-color-text-tertiary hidden md:block">|</span>
